...
export const translations = {
  es: {
    ...
    // Dashboard Page
    'dashboard.subtitle': 'Panel de control de elementos de protección personal y firmas.',
    'dashboard.viewPersonnel': 'Ver Personal',
    'dashboard.deliverEPP': 'Entregar EPP',
    'dashboard.complianceRate': 'Tasa de Cumplimiento',
    'dashboard.complianceDesc': 'EPP entregados con firma',
    'dashboard.pendingSigs': 'Firmas Pendientes',
    'dashboard.pendingSigsDesc': 'Requieren firma manuscrita',
    'dashboard.activeWorkers': 'Operarios Activos',
    'dashboard.activeWorkersDesc': 'Personal registrado',
    'dashboard.totalDelivered': 'EPP Entregados',
    'dashboard.totalDeliveredDesc': 'Total histórico de entregas',
    'dashboard.criticalStockAlert': 'Alerta de Stock Crítico',
    'dashboard.criticalStockDesc': 'Los siguientes elementos del catálogo tienen poco stock disponible. Reponer a la brevedad:',
    'dashboard.recentDeliveriesTitle': 'Planilla de Entregas Recientes',
    'dashboard.company': 'Empresa',
    'dashboard.loadingDeliveries': 'Cargando entregas...',
    'dashboard.noDeliveries': 'No hay entregas registradas',
    'dashboard.clickDeliverEPP': 'Hacé clic en "Entregar EPP" para iniciar.',
    'dashboard.quickCatalog': 'Catálogo Rápido',
    'dashboard.manage': 'Gestionar',
    'dashboard.emptyCatalog': 'Catálogo vacío',
    'dashboard.voiceTitle': 'Dictá por voz',
    'dashboard.voiceDesc': '¿Estás ocupado o con las manos llenas? Tocá el micrófono abajo a la derecha y decile al asistente qué estás entregando y a quién. Se cargará solo.',
    'dashboard.handsFree': 'Manos Libres · Optimizado',
    'dashboard.registerDeliveryModal': 'Registrar Entrega de EPP',
    'dashboard.selectWorker': 'Seleccionar Trabajador',
    'dashboard.selectPPE': 'Seleccionar EPP',
    'dashboard.quantity': 'Cantidad',
    'dashboard.notes': 'Notas / Observaciones (Opcional)',
    'dashboard.cancel': 'Cancelar',
    'dashboard.registerAndSign': 'Registrar y Firmar',
    'dashboard.registering': 'Registrando...',
    'dashboard.worker': 'Operario',
    'dashboard.units': 'unidades',
    'dashboard.signed': 'Firmado',
    'dashboard.sign': 'Firmar',
    'dashboard.signature': 'Firma:',

    // Employees / Operarios Page
    'employees.title': 'Gestión de Operarios y Trabajadores',
    'employees.subtitle': 'Registrá y administrá el personal de obra para la asignación y firma de EPP.',
    'employees.newWorker': 'Nuevo Operario',
    'employees.importExcel': 'Importar Excel',
    'employees.exportExcel': 'Exportar Excel',
    'employees.searchPlaceholder': 'Buscar por nombre, DNI o cargo...',
    'employees.colWorker': 'Operario / Trabajador',
    'employees.colDni': 'DNI / CUIL',
    'employees.colFile': 'Legajo',
    'employees.colTitle': 'Puesto / Cargo',
    ...
    'employees.deliverPPE': 'Entregar EPP',
    'employees.edit': 'Editar',
    'employees.form299': 'Constancia 299',
    'employees.delete': 'Eliminar',

    // EPP Inventory Page
    'inventory.title': 'Catálogo e Inventario de EPP',
    'inventory.subtitle': 'Gestión de stock, categorías y certificaciones IRAM / SRT para elementos de protección.',
    'inventory.catalogItem': 'Catalogar EPP',
    'inventory.colItem': 'Elemento / Descripción',
    'inventory.colCategory': 'Categoría',
    'inventory.colTypeModel': 'Tipo / Modelo',
    'inventory.colBrand': 'Marca',
    'inventory.colStock': 'Stock Disponible',
    'inventory.colCert': 'Certificación',
    'inventory.colActions': 'Acciones',
    'inventory.replenish': 'Reponer Stock',

    // Reports Page
    'reports.title': 'Reportes y Constancias de Entrega',
    'reports.subtitle': 'Historial completo de entregas de EPP, exportación a Excel y descarga de Formulario 299/11 oficial.',
    'reports.allDeliveries': 'Todas las entregas',
    'reports.signed': 'Firmadas',
    'reports.pending': 'Pendientes',
    'reports.colWorker': 'Trabajador',
    'reports.colPPE': 'Elemento EPP',
    'reports.colQty': 'Cantidad',
    'reports.colDate': 'Fecha',
    'reports.colStatus': 'Estado / Firma',
    'reports.colActions': 'Constancia / Acciones',
    'reports.downloadPdf': 'Descargar PDF 299',

    // Users & Roles Page
    'users.title': 'Gestión de Usuarios y Roles',
    'users.subtitle': 'Administrá los accesos, roles y permisos de tu equipo.',
    'users.inviteUser': 'Invitar Usuario',
    'users.manageRoles': 'Gestionar Roles y Permisos',
    'users.colUser': 'Usuario / Email',
    'users.colRole': 'Rol',
    'users.colCompany': 'Empresa',
    'users.colStatus': 'Estado',
    'users.colCreated': 'Fecha de Alta',
  ...
  en: {
    ...
    // Dashboard Page
    'dashboard.subtitle': 'Control panel for personal protective equipment and signatures.',
    'dashboard.viewPersonnel': 'View Personnel',
    'dashboard.deliverEPP': 'Deliver PPE',
    'dashboard.complianceRate': 'Compliance Rate',
    'dashboard.complianceDesc': 'PPE delivered with signature',
    'dashboard.pendingSigs': 'Pending Signatures',
    'dashboard.pendingSigsDesc': 'Requires manuscript signature',
    'dashboard.activeWorkers': 'Active Workers',
    'dashboard.activeWorkersDesc': 'Registered personnel',
    'dashboard.totalDelivered': 'PPE Delivered',
    'dashboard.totalDeliveredDesc': 'Historical total deliveries',
    'dashboard.criticalStockAlert': 'Critical Stock Alert',
    'dashboard.criticalStockDesc': 'The following catalog items have low available stock. Replenish as soon as possible:',
    'dashboard.recentDeliveriesTitle': 'Recent Delivery Log',
    'dashboard.company': 'Company',
    'dashboard.loadingDeliveries': 'Loading deliveries...',
    'dashboard.noDeliveries': 'No registered deliveries',
    'dashboard.clickDeliverEPP': 'Click "Deliver PPE" to start.',
    'dashboard.quickCatalog': 'Quick Catalog',
    'dashboard.manage': 'Manage',
    'dashboard.emptyCatalog': 'Empty catalog',
    'dashboard.voiceTitle': 'Voice Dictation',
    'dashboard.voiceDesc': 'Busy or hands full? Tap the microphone button at the bottom right and tell the assistant what you are delivering and to whom. It will load automatically.',
    'dashboard.handsFree': 'Hands-Free · Optimized',
    'dashboard.registerDeliveryModal': 'Register PPE Delivery',
    'dashboard.selectWorker': 'Select Worker',
    'dashboard.selectPPE': 'Select PPE',
    'dashboard.quantity': 'Quantity',
    'dashboard.notes': 'Notes / Remarks (Optional)',
    'dashboard.cancel': 'Cancel',
    'dashboard.registerAndSign': 'Register & Sign',
    ...
    // Employees / Operarios Page
    'employees.title': 'Worker & Personnel Management',
    'employees.subtitle': 'Register and manage site personnel for PPE assignment and signing.',
    'employees.newWorker': 'New Worker',
    'employees.importExcel': 'Import Excel',
    'employees.exportExcel': 'Export Excel',
    'employees.searchPlaceholder': 'Search by name, ID or job title...',
    'employees.colWorker': 'Worker / Employee',
    'employees.colDni': 'ID / CUIL',
    'employees.colFile': 'File No.',
    'employees.colTitle': 'Job Title',
    ...
    'employees.deliverPPE': 'Deliver PPE',
    'employees.edit': 'Edit',
    'employees.form299': 'Form 299',
    'employees.delete': 'Delete',

    // EPP Inventory Page
    'inventory.title': 'PPE Catalog & Inventory',
    'inventory.subtitle': 'Stock management, categories, and IRAM / SRT certifications for protective equipment.',
    'inventory.catalogItem': 'Catalog PPE Item',
    'inventory.colItem': 'Item / Description',
    'inventory.colCategory': 'Category',
    'inventory.colTypeModel': 'Type / Model',
    'inventory.colBrand': 'Brand',
    'inventory.colStock': 'Available Stock',
    'inventory.colCert': 'Certification',
    'inventory.colActions': 'Actions',
    'inventory.replenish': 'Replenish Stock',

    // Reports Page
    'reports.title': 'Delivery Reports & Logs',
    'reports.subtitle': 'Complete history of PPE deliveries, Excel export, and official Form 299/11 download.',
    'reports.allDeliveries': 'All Deliveries',
    'reports.signed': 'Signed',
    'reports.pending': 'Pending',
    'reports.colWorker': 'Worker',
    'reports.colPPE': 'PPE Item',
    'reports.colQty': 'Quantity',
    'reports.colDate': 'Date',
    'reports.colStatus': 'Status / Signature',
    'reports.colActions': 'Receipt / Actions',
    'reports.downloadPdf': 'Download PDF 299',

    // Users & Roles Page
    'users.title': 'User & Role Management',
    'users.subtitle': 'Manage access, roles, and permissions for your team.',
    'users.inviteUser': 'Invite User',
    'users.manageRoles': 'Manage Roles & Permissions',
    'users.colUser': 'User / Email',
    'users.colRole': 'Role',
    'users.colCompany': 'Company',
    'users.colStatus': 'Status',
    'users.colCreated': 'Created Date',
